...
<head>
    ...
    <title>Donation Add Form</title>
    <link rel="stylesheet" href="<c:url value="/resources/css/style.css"/>"/>
</head>
<body>
<jsp:include page="formHeader.jsp"></jsp:include>
                           ...
                           <div class="form-group form-group--checkbox">
                               <label>
                                   <input
                                           type="checkbox"
                                           name="categories"
                                           id="categories<c:out value = "${category.id}"/>"
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        ...
                        <span class="description">
                            ...
                            <div class="subtitle">Cel i misja: <c:out value = "${institution.description}"/> <sytuacji></sytuacji>życiowej.
                            </div>
                        </span>
                    </label>
                </div>
        ...
        <div data-step="4">
            ...
            <div class="form-section form-section--columns">
                <div class="form-section--column">
                    ...
                    <div class="form-group form-group--inline">
                        <label>
                            Numer telefonu <form:input path="phone" type="text" name="phone"/>
                        </label>
                    </div>
                </div>
